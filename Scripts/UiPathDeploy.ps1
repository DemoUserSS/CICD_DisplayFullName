...
SYNTAX
  ...
  Examples:
    ...
    . '\UiPathDeploy.ps1' "C:\UiPath\Project\Package.1.0.6820.22047.nupkg" "https://uipath-orchestrator.myorg.com" default -UserKey BoHfYQTv8EqTjGI6lniCxdfWsElG8iQ7SXAzUXsyTYqHF -account_name myAccount
